...
- generated_at: `2026-06-07T15:05:14`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 31.4 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 22.2 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 16.5 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 59.9 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 24.8 | command exited 0 |
| visualization source contract | PASS | 0 | 15.2 | command exited 0 |
...
| runtime action-name labels | PASS | 0 | 20.5 | command exited 0 |
| field runbook source contract | PASS | 0 | 14.9 | command exited 0 |
| field evidence status self-test | PASS | 0 | 125.1 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 86.3 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 15.1 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 57.9 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 58.7 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 148.2 | command exited 0 |
...
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 78.7 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 59.9 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 103.7 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 717.2 | command exited 0 |
...
2026-06-07 15:05:14,027 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 15:05:14,027 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
