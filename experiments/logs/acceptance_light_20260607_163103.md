...
- generated_at: `2026-06-07T16:31:03`
...
| GIS global-prior JSON acceptance self-test | PASS | 0 | 68.3 | command exited 0 |
...
| field runbook source contract | PASS | 0 | 15.9 | command exited 0 |
| field evidence status self-test | PASS | 0 | 439.8 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 86.6 | command exited 0 |
| Orin environment report acceptance self-test | PASS | 0 | 94.1 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 15.6 | command exited 0 |
| experiment requirement audit self-test | PASS | 0 | 179.4 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 56.9 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 61.1 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 189.7 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 70.8 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 81.2 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 99.4 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 73.5 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 58.8 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 166.0 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 706.3 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 25.2 | flight-ready preview has only expected field-configuration gaps |
...
2026-06-07 16:31:03,766 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 16:31:03,766 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
