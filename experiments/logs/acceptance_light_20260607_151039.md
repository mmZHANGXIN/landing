...
- generated_at: `2026-06-07T15:10:39`
...
| GIS nine-grid lightweight contract | PASS | 0 | 18.4 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 63.5 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 27.0 | command exited 0 |
...
| field evidence status self-test | PASS | 0 | 127.5 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 83.4 | command exited 0 |
| Orin environment report acceptance self-test | PASS | 0 | 76.3 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 15.5 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 57.3 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 58.1 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 147.7 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 71.9 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 82.7 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 102.7 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 75.6 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 61.2 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 106.8 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 713.0 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 25.5 | flight-ready preview has only expected field-configuration gaps |
| pipeline flight-ready check-only with GIS override | PASS | 0 | 37.2 | command exited 0 |
...
2026-06-07 15:10:39,932 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 15:10:39,932 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
