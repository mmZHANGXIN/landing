...
- generated_at: `2026-06-07T13:48:23`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 35.6 | command exited 0 |
...
| HALSS visualization lightweight contract | PASS | 0 | 28.1 | command exited 0 |
...
| runtime action-name labels | PASS | 0 | 24.0 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 61.8 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 73.0 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 77.9 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 61.0 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 61.8 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 757.8 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 27.5 | flight-ready preview has only expected field-configuration gaps |
| pipeline flight-ready check-only with GIS override | PASS | 0 | 38.8 | command exited 0 |
...
2026-06-07 13:48:23,342 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 13:48:23,342 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
