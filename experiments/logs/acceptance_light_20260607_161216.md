...
- generated_at: `2026-06-07T16:12:16`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 30.6 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 22.9 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 16.7 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 62.6 | command exited 0 |
...
| field evidence status self-test | PASS | 0 | 446.0 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 83.5 | command exited 0 |
| Orin environment report acceptance self-test | PASS | 0 | 95.7 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 15.4 | command exited 0 |
| experiment requirement audit self-test | PASS | 0 | 183.9 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 61.5 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 62.5 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 172.6 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 72.8 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 83.3 | command exited 0 |
...
| flight-loop log acceptance self-test | PASS | 0 | 151.0 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 712.8 | command exited 0 |
...
2026-06-07 16:12:16,470 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 16:12:16,470 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
