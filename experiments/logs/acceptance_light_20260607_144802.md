...
- generated_at: `2026-06-07T14:48:02`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 29.4 | command exited 0 |
...
| yaw-aware action decomposition | PASS | 0 | 16.1 | command exited 0 |
| runtime action-name labels | PASS | 0 | 20.8 | command exited 0 |
| field runbook source contract | PASS | 0 | 15.4 | command exited 0 |
| field evidence status self-test | PASS | 0 | 69.0 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 15.4 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 38.1 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 58.8 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 147.9 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 71.9 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 83.1 | command exited 0 |
...
| ROS topic evidence acceptance self-test | PASS | 0 | 60.2 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 105.3 | command exited 0 |
| strict flight-ready gate regression | FAIL | 1 | 599.9 | command exited 1 |
| flight-ready preflight preview | PASS | 1 | 26.3 | flight-ready preview has only expected field-configuration gaps |
| pipeline flight-ready check-only with GIS override | PASS | 0 | 37.1 | command exited 0 |
...
Traceback (most recent call last):
  File "/Users/evelyn/Desktop/orinlanding/orinlanding/test_flight_ready_gates.py", line 362, in <module>
    test_binary_semantic_window_title_required()
  File "/Users/evelyn/Desktop/orinlanding/orinlanding/test_flight_ready_gates.py", line 294, in test_binary_semantic_window_title_required
    assert result.returncode != 0, f"binary semantic title: expected failure\n{text}"
AssertionError: binary semantic title: expected failure
2026-06-07 14:48:02,425 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 14:48:02,426 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
...
2026-06-07 14:48:02,492 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 14:48:02,492 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
