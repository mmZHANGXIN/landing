...
- generated_at: `2026-06-07T17:48:20`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 42.1 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 32.9 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 24.9 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 156.2 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 43.3 | command exited 0 |
| visualization source contract | PASS | 0 | 25.4 | command exited 0 |
| depth projection lightweight contract | PASS | 0 | 20.5 | command exited 0 |
| SparseNet sparse convolution lightweight contract | PASS | 0 | 18.4 | command exited 0 |
| yaw-aware action decomposition | PASS | 0 | 26.0 | command exited 0 |
| runtime action-name labels | PASS | 0 | 36.5 | command exited 0 |
| field runbook source contract | PASS | 0 | 27.1 | command exited 0 |
| field evidence status self-test | PASS | 0 | 1539.5 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 172.6 | command exited 0 |
| Orin environment report acceptance self-test | PASS | 0 | 193.9 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 32.5 | command exited 0 |
| experiment requirement audit self-test | PASS | 0 | 356.8 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 153.5 | command exited 0 |
| closed-loop diagnostic snapshot contract | PASS | 0 | 31.1 | command exited 0 |
| MAVSDK home telemetry contract | PASS | 0 | 27.7 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 112.3 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 424.9 | command exited 0 |
| no-control action diagnosis self-test | PASS | 0 | 201.5 | command exited 0 |
| no-control runtime contract self-test | PASS | 0 | 31.3 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 318.4 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 149.0 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 182.1 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 136.1 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 109.1 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 476.4 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 1297.4 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 48.3 | flight-ready preview has only expected field-configuration gaps |
| pipeline flight-ready check-only with GIS override | PASS | 0 | 66.5 | command exited 0 |
...
2026-06-07 17:48:20,301 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 17:48:20,302 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
