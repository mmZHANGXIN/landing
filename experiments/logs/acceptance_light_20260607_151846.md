...
- generated_at: `2026-06-07T15:18:46`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 33.0 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 22.4 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 16.9 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 62.4 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 26.6 | command exited 0 |
| visualization source contract | PASS | 0 | 15.7 | command exited 0 |
...
| field evidence status self-test | PASS | 0 | 151.9 | command exited 0 |
...
| field acceptance wrapper self-test | PASS | 0 | 57.4 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 62.6 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 148.6 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 72.6 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 84.1 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 102.8 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 76.0 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 61.2 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 104.9 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 717.3 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 26.1 | flight-ready preview has only expected field-configuration gaps |
| pipeline flight-ready check-only with GIS override | PASS | 0 | 36.6 | command exited 0 |
...
2026-06-07 15:18:46,026 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 15:18:46,027 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
