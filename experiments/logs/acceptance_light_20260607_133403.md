...
- generated_at: `2026-06-07T13:34:03`
...
| SparseNet sparse convolution lightweight contract | PASS | 0 | 12.3 | command exited 0 |
| yaw-aware action decomposition | PASS | 0 | 16.3 | command exited 0 |
| runtime action-name labels | PASS | 0 | 24.7 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 66.1 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 75.2 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 61.7 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 770.2 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 27.7 | flight-ready preview has only expected field-configuration gaps |
| pipeline flight-ready check-only with GIS override | PASS | 0 | 39.2 | command exited 0 |
...
2026-06-07 13:34:03,666 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 13:34:03,666 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
