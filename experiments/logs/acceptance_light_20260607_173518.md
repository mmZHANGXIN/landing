...
- generated_at: `2026-06-07T17:35:18`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 38.3 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 22.7 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 16.7 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 102.8 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 26.8 | command exited 0 |
| visualization source contract | PASS | 0 | 15.6 | command exited 0 |
| depth projection lightweight contract | PASS | 0 | 12.0 | command exited 0 |
...
| runtime action-name labels | PASS | 0 | 21.5 | command exited 0 |
| field runbook source contract | PASS | 0 | 15.0 | command exited 0 |
| field evidence status self-test | PASS | 0 | 451.0 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 84.5 | command exited 0 |
| Orin environment report acceptance self-test | PASS | 0 | 93.2 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 14.8 | command exited 0 |
| experiment requirement audit self-test | PASS | 0 | 180.4 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 76.9 | command exited 0 |
| closed-loop diagnostic snapshot contract | PASS | 0 | 16.1 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 57.5 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 212.8 | command exited 0 |
| no-control action diagnosis self-test | PASS | 0 | 102.0 | command exited 0 |
| no-control runtime contract self-test | PASS | 0 | 14.8 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 170.1 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 80.9 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 100.6 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 73.6 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 59.0 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 212.3 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 700.6 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 25.7 | flight-ready preview has only expected field-configuration gaps |
...
2026-06-07 17:35:18,748 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 17:35:18,748 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
