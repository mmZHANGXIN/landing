...
- generated_at: `2026-06-07T14:07:27`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 27.1 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 23.2 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 17.8 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 63.2 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 27.3 | command exited 0 |
...
| timing log acceptance self-test | PASS | 0 | 59.4 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 62.4 | command exited 0 |
...
| flight-loop log acceptance self-test | PASS | 0 | 62.9 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 722.4 | command exited 0 |
...
2026-06-07 14:07:27,438 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 14:07:27,439 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
