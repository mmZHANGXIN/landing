...
- generated_at: `2026-06-07T15:14:54`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 32.6 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 22.7 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 17.4 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 61.4 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 25.3 | command exited 0 |
| visualization source contract | PASS | 0 | 15.9 | command exited 0 |
...
| runtime action-name labels | PASS | 0 | 21.8 | command exited 0 |
| field runbook source contract | PASS | 0 | 15.5 | command exited 0 |
| field evidence status self-test | PASS | 0 | 127.2 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 85.1 | command exited 0 |
...
| field acceptance wrapper self-test | PASS | 0 | 57.7 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 58.6 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 148.4 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 74.3 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 84.6 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 102.9 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 75.5 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 61.3 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 105.1 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 719.6 | command exited 0 |
...
2026-06-07 15:14:54,342 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 15:14:54,342 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
