...
- generated_at: `2026-06-08T11:11:13`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 30.8 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 22.4 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 17.0 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 100.9 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 26.5 | command exited 0 |
| visualization source contract | PASS | 0 | 15.1 | command exited 0 |
| depth projection lightweight contract | PASS | 0 | 13.5 | command exited 0 |
| SparseNet sparse convolution lightweight contract | PASS | 0 | 10.3 | command exited 0 |
| yaw-aware action decomposition | PASS | 0 | 14.6 | command exited 0 |
| runtime action-name labels | PASS | 0 | 21.1 | command exited 0 |
| field runbook source contract | PASS | 0 | 14.9 | command exited 0 |
| field evidence status self-test | PASS | 0 | 748.6 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 83.4 | command exited 0 |
| Orin environment report acceptance self-test | PASS | 0 | 94.8 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 14.9 | command exited 0 |
| experiment requirement audit self-test | PASS | 0 | 174.5 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 75.6 | command exited 0 |
| closed-loop diagnostic snapshot contract | PASS | 0 | 14.3 | command exited 0 |
| MAVSDK home telemetry contract | PASS | 0 | 13.9 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 56.3 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 209.5 | command exited 0 |
| no-control action diagnosis self-test | PASS | 0 | 99.4 | command exited 0 |
| no-control runtime contract self-test | PASS | 0 | 14.5 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 168.6 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 79.5 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 97.8 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 72.9 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 57.6 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 254.7 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 728.9 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 24.9 | flight-ready preview has only expected field-configuration gaps |
| pipeline flight-ready check-only with GIS override | PASS | 0 | 35.7 | command exited 0 |
...
2026-06-08 11:11:13,800 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-08 11:11:13,800 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
