...
- generated_at: `2026-06-08T11:45:31`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 32.1 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 22.7 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 16.9 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 101.9 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 26.7 | command exited 0 |
| visualization source contract | PASS | 0 | 15.5 | command exited 0 |
| depth projection lightweight contract | PASS | 0 | 13.6 | command exited 0 |
| CUDA depth projection log acceptance self-test | PASS | 0 | 74.2 | command exited 0 |
| SparseNet sparse convolution lightweight contract | PASS | 0 | 11.4 | command exited 0 |
| yaw-aware action decomposition | PASS | 0 | 15.0 | command exited 0 |
| runtime action-name labels | PASS | 0 | 21.6 | command exited 0 |
| field runbook source contract | PASS | 0 | 16.0 | command exited 0 |
| field evidence status self-test | PASS | 0 | 805.4 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 88.3 | command exited 0 |
| Orin environment report acceptance self-test | PASS | 0 | 93.8 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 15.0 | command exited 0 |
| experiment requirement audit self-test | PASS | 0 | 180.9 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 78.7 | command exited 0 |
| closed-loop diagnostic snapshot contract | PASS | 0 | 18.2 | command exited 0 |
| MAVSDK home telemetry contract | PASS | 0 | 14.5 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 57.1 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 213.0 | command exited 0 |
| no-control action diagnosis self-test | PASS | 0 | 102.9 | command exited 0 |
| no-control runtime contract self-test | PASS | 0 | 15.1 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 171.3 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 80.8 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 99.0 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 73.3 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 57.9 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 257.3 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 736.3 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 25.0 | flight-ready preview has only expected field-configuration gaps |
| pipeline flight-ready check-only with GIS override | PASS | 0 | 36.4 | command exited 0 |
...
2026-06-08 11:45:31,812 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-08 11:45:31,812 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
