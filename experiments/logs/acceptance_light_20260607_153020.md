...
- generated_at: `2026-06-07T15:30:20`
...
| GIS global-prior JSON acceptance self-test | PASS | 0 | 61.8 | command exited 0 |
...
| field runbook source contract | PASS | 0 | 15.1 | command exited 0 |
| field evidence status self-test | PASS | 0 | 152.6 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 83.2 | command exited 0 |
| Orin environment report acceptance self-test | PASS | 0 | 95.5 | command exited 0 |
...
| timing log acceptance self-test | PASS | 0 | 59.0 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 148.2 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 73.6 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 84.2 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 103.0 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 75.1 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 60.3 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 126.1 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 715.5 | command exited 0 |
...
2026-06-07 15:30:20,391 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 15:30:20,391 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
