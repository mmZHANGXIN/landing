...
- generated_at: `2026-06-07T14:15:34`
...
| timing log acceptance self-test | PASS | 0 | 59.3 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 105.3 | command exited 0 |
...
| flight-loop log acceptance self-test | PASS | 0 | 82.8 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 720.5 | command exited 0 |
...
2026-06-07 14:15:34,165 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 14:15:34,165 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
