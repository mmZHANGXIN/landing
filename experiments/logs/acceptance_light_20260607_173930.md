...
- generated_at: `2026-06-07T17:39:30`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 42.4 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 33.3 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 25.3 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 169.0 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 43.1 | command exited 0 |
| visualization source contract | PASS | 0 | 28.4 | command exited 0 |
| depth projection lightweight contract | PASS | 0 | 22.2 | command exited 0 |
| SparseNet sparse convolution lightweight contract | PASS | 0 | 19.3 | command exited 0 |
| yaw-aware action decomposition | PASS | 0 | 27.4 | command exited 0 |
| runtime action-name labels | PASS | 0 | 37.3 | command exited 0 |
| field runbook source contract | PASS | 0 | 26.0 | command exited 0 |
| field evidence status self-test | PASS | 0 | 1502.3 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 170.7 | command exited 0 |
| Orin environment report acceptance self-test | PASS | 0 | 192.2 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 32.6 | command exited 0 |
| experiment requirement audit self-test | PASS | 0 | 354.9 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 149.6 | command exited 0 |
| closed-loop diagnostic snapshot contract | PASS | 0 | 30.4 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 111.2 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 418.0 | command exited 0 |
| no-control action diagnosis self-test | PASS | 0 | 199.8 | command exited 0 |
| no-control runtime contract self-test | PASS | 0 | 30.9 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 322.0 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 150.4 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 184.4 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 135.5 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 107.5 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 403.5 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 1304.2 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 48.8 | flight-ready preview has only expected field-configuration gaps |
| pipeline flight-ready check-only with GIS override | PASS | 0 | 68.1 | command exited 0 |
...
2026-06-07 17:39:30,357 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 17:39:30,357 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
