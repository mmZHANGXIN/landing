...
- generated_at: `2026-06-07T14:03:49`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 34.5 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 24.3 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 18.7 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 63.2 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 26.6 | command exited 0 |
| visualization source contract | PASS | 0 | 16.1 | command exited 0 |
...
| runtime action-name labels | PASS | 0 | 24.1 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 60.8 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 63.9 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 75.3 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 80.1 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 62.7 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 63.1 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 750.9 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 28.4 | flight-ready preview has only expected field-configuration gaps |
...
2026-06-07 14:03:49,807 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 14:03:49,808 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
