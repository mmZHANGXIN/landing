...
- generated_at: `2026-06-07T16:18:05`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 34.0 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 23.3 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 16.9 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 62.1 | command exited 0 |
...
| SparseNet sparse convolution lightweight contract | PASS | 0 | 11.0 | command exited 0 |
| yaw-aware action decomposition | PASS | 0 | 15.5 | command exited 0 |
| runtime action-name labels | PASS | 0 | 22.5 | command exited 0 |
| field runbook source contract | PASS | 0 | 15.3 | command exited 0 |
| field evidence status self-test | PASS | 0 | 443.7 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 85.2 | command exited 0 |
| Orin environment report acceptance self-test | PASS | 0 | 95.1 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 15.4 | command exited 0 |
| experiment requirement audit self-test | PASS | 0 | 179.0 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 58.3 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 61.9 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 171.8 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 73.8 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 83.8 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 101.1 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 75.4 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 60.3 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 147.7 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 716.3 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 26.6 | flight-ready preview has only expected field-configuration gaps |
...
2026-06-07 16:18:05,130 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 16:18:05,130 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
