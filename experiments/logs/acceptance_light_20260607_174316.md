...
- generated_at: `2026-06-07T17:43:16`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 41.9 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 33.7 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 27.5 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 169.3 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 44.9 | command exited 0 |
| visualization source contract | PASS | 0 | 27.0 | command exited 0 |
| depth projection lightweight contract | PASS | 0 | 21.4 | command exited 0 |
| SparseNet sparse convolution lightweight contract | PASS | 0 | 18.4 | command exited 0 |
| yaw-aware action decomposition | PASS | 0 | 26.1 | command exited 0 |
| runtime action-name labels | PASS | 0 | 36.7 | command exited 0 |
| field runbook source contract | PASS | 0 | 26.4 | command exited 0 |
| field evidence status self-test | PASS | 0 | 1532.2 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 171.9 | command exited 0 |
| Orin environment report acceptance self-test | PASS | 0 | 192.2 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 33.1 | command exited 0 |
| experiment requirement audit self-test | PASS | 0 | 363.7 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 159.1 | command exited 0 |
| closed-loop diagnostic snapshot contract | PASS | 0 | 32.4 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 113.7 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 421.1 | command exited 0 |
| no-control action diagnosis self-test | PASS | 0 | 206.3 | command exited 0 |
| no-control runtime contract self-test | PASS | 0 | 29.8 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 332.4 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 152.5 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 183.8 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 136.1 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 107.7 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 495.3 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 1309.0 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 49.9 | flight-ready preview has only expected field-configuration gaps |
| pipeline flight-ready check-only with GIS override | PASS | 0 | 68.0 | command exited 0 |
...
2026-06-07 17:43:16,235 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 17:43:16,236 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
