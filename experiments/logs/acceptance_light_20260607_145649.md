...
- generated_at: `2026-06-07T14:56:49`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 31.6 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 22.9 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 17.0 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 63.1 | command exited 0 |
...
| runtime action-name labels | PASS | 0 | 20.9 | command exited 0 |
| field runbook source contract | PASS | 0 | 14.7 | command exited 0 |
| field evidence status self-test | PASS | 0 | 98.3 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 14.9 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 37.4 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 58.8 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 149.2 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 72.4 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 82.3 | command exited 0 |
...
| flight-loop log acceptance self-test | PASS | 0 | 104.7 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 714.7 | command exited 0 |
...
2026-06-07 14:56:49,436 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 14:56:49,436 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
