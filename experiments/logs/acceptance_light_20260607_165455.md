...
- generated_at: `2026-06-07T16:54:55`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 31.2 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 23.8 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 17.3 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 62.3 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 28.8 | command exited 0 |
| visualization source contract | PASS | 0 | 17.4 | command exited 0 |
| depth projection lightweight contract | PASS | 0 | 12.6 | command exited 0 |
| SparseNet sparse convolution lightweight contract | PASS | 0 | 10.8 | command exited 0 |
| yaw-aware action decomposition | PASS | 0 | 15.1 | command exited 0 |
| runtime action-name labels | PASS | 0 | 21.2 | command exited 0 |
| field runbook source contract | PASS | 0 | 15.6 | command exited 0 |
| field evidence status self-test | PASS | 0 | 449.2 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 82.0 | command exited 0 |
| Orin environment report acceptance self-test | PASS | 0 | 95.0 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 15.3 | command exited 0 |
| experiment requirement audit self-test | PASS | 0 | 178.9 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 56.8 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 60.6 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 211.9 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 171.5 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 81.5 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 100.2 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 73.8 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 58.5 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 191.5 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 700.2 | command exited 0 |
...
2026-06-07 16:54:55,143 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 16:54:55,143 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
