...
- generated_at: `2026-06-07T15:25:57`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 29.5 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 22.6 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 17.0 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 63.7 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 26.1 | command exited 0 |
| visualization source contract | PASS | 0 | 15.5 | command exited 0 |
| depth projection lightweight contract | PASS | 0 | 12.7 | command exited 0 |
...
| runtime action-name labels | PASS | 0 | 20.6 | command exited 0 |
| field runbook source contract | PASS | 0 | 15.6 | command exited 0 |
| field evidence status self-test | PASS | 0 | 153.9 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 81.7 | command exited 0 |
...
| timing log acceptance self-test | PASS | 0 | 57.9 | command exited 0 |
...
| flight-loop log acceptance self-test | PASS | 0 | 104.8 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 705.7 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 25.9 | flight-ready preview has only expected field-configuration gaps |
| pipeline flight-ready check-only with GIS override | PASS | 0 | 37.5 | command exited 0 |
...
2026-06-07 15:25:57,113 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 15:25:57,113 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
