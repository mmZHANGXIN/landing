...
- generated_at: `2026-06-07T13:30:11`
- root: `/Users/evelyn/Desktop/orinlanding/orinlanding`
- overall: `FAIL`
- strict_flight_ready: `True`
...
| runtime action-name labels | PASS | 0 | 22.8 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 62.5 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 72.8 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 743.0 | command exited 0 |
| flight-ready preflight preview | FAIL | 1 | 27.8 | strict flight-ready required, command exited 1 |
...
2026-06-07 13:30:11,061 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 13:30:11,061 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
