...
- generated_at: `2026-06-07T14:41:32`
...
| GIS global-prior JSON acceptance self-test | PASS | 0 | 64.3 | command exited 0 |
...
| field runbook source contract | PASS | 0 | 14.4 | command exited 0 |
| field evidence status self-test | PASS | 0 | 69.1 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 15.3 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 37.0 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 59.5 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 126.3 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 72.3 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 83.2 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 102.5 | command exited 0 |
...
| strict flight-ready gate regression | PASS | 0 | 716.1 | command exited 0 |
...
2026-06-07 14:41:32,808 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 14:41:32,808 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
