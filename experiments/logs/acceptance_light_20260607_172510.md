...
- generated_at: `2026-06-07T17:25:10`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 29.7 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 24.4 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 18.2 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 100.7 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 24.7 | command exited 0 |
| visualization source contract | PASS | 0 | 14.9 | command exited 0 |
| depth projection lightweight contract | PASS | 0 | 11.7 | command exited 0 |
| SparseNet sparse convolution lightweight contract | PASS | 0 | 10.7 | command exited 0 |
| yaw-aware action decomposition | PASS | 0 | 14.9 | command exited 0 |
| runtime action-name labels | PASS | 0 | 21.3 | command exited 0 |
| field runbook source contract | PASS | 0 | 15.3 | command exited 0 |
| field evidence status self-test | PASS | 0 | 440.4 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 83.3 | command exited 0 |
| Orin environment report acceptance self-test | PASS | 0 | 92.4 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 14.7 | command exited 0 |
| experiment requirement audit self-test | PASS | 0 | 178.2 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 76.5 | command exited 0 |
| closed-loop diagnostic snapshot contract | PASS | 0 | 16.0 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 57.0 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 211.5 | command exited 0 |
| no-control runtime contract self-test | PASS | 0 | 14.9 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 172.7 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 80.6 | command exited 0 |
...
| ROS topic evidence acceptance self-test | PASS | 0 | 58.4 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 212.4 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 699.4 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 25.5 | flight-ready preview has only expected field-configuration gaps |
| pipeline flight-ready check-only with GIS override | PASS | 0 | 36.2 | command exited 0 |
...
2026-06-07 17:25:10,540 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 17:25:10,540 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
