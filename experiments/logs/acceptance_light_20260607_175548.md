...
- generated_at: `2026-06-07T17:55:48`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 47.2 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 38.6 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 28.9 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 167.8 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 45.1 | command exited 0 |
| visualization source contract | PASS | 0 | 26.1 | command exited 0 |
| depth projection lightweight contract | PASS | 0 | 23.0 | command exited 0 |
| SparseNet sparse convolution lightweight contract | PASS | 0 | 18.1 | command exited 0 |
| yaw-aware action decomposition | PASS | 0 | 25.4 | command exited 0 |
| runtime action-name labels | PASS | 0 | 35.7 | command exited 0 |
| field runbook source contract | PASS | 0 | 25.8 | command exited 0 |
| field evidence status self-test | PASS | 0 | 1612.8 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 168.8 | command exited 0 |
| Orin environment report acceptance self-test | PASS | 0 | 193.9 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 30.7 | command exited 0 |
| experiment requirement audit self-test | PASS | 0 | 355.7 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 150.8 | command exited 0 |
| closed-loop diagnostic snapshot contract | PASS | 0 | 30.1 | command exited 0 |
| MAVSDK home telemetry contract | PASS | 0 | 27.6 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 111.6 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 423.4 | command exited 0 |
| no-control action diagnosis self-test | PASS | 0 | 190.0 | command exited 0 |
| no-control runtime contract self-test | PASS | 0 | 29.3 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 310.3 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 148.0 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 181.8 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 138.7 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 108.7 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 478.0 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 1298.3 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 47.9 | flight-ready preview has only expected field-configuration gaps |
| pipeline flight-ready check-only with GIS override | PASS | 0 | 69.2 | command exited 0 |
...
2026-06-07 17:55:48,675 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 17:55:48,675 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
