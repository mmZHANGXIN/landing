...
- generated_at: `2026-06-07T17:02:39`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 33.2 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 23.3 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 17.1 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 61.0 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 24.6 | command exited 0 |
...
| SparseNet sparse convolution lightweight contract | PASS | 0 | 10.6 | command exited 0 |
| yaw-aware action decomposition | PASS | 0 | 14.8 | command exited 0 |
| runtime action-name labels | PASS | 0 | 21.0 | command exited 0 |
| field runbook source contract | PASS | 0 | 14.8 | command exited 0 |
| field evidence status self-test | PASS | 0 | 445.5 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 82.3 | command exited 0 |
| Orin environment report acceptance self-test | PASS | 0 | 93.2 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 15.1 | command exited 0 |
| experiment requirement audit self-test | PASS | 0 | 178.1 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 57.6 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 61.5 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 212.1 | command exited 0 |
| no-control runtime contract self-test | PASS | 0 | 14.8 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 170.5 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 81.3 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 99.8 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 74.3 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 58.3 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 188.4 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 700.1 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 25.1 | flight-ready preview has only expected field-configuration gaps |
...
2026-06-07 17:02:39,366 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 17:02:39,366 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
