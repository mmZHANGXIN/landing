...
- generated_at: `2026-06-07T13:57:49`
...
| GIS nine-grid lightweight contract | PASS | 0 | 18.9 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 66.4 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 28.4 | command exited 0 |
| visualization source contract | PASS | 0 | 17.2 | command exited 0 |
| depth projection lightweight contract | PASS | 0 | 13.1 | command exited 0 |
| SparseNet sparse convolution lightweight contract | PASS | 0 | 11.9 | command exited 0 |
| yaw-aware action decomposition | PASS | 0 | 15.8 | command exited 0 |
| runtime action-name labels | PASS | 0 | 25.0 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 59.1 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 62.3 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 72.7 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 77.6 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 61.1 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 62.3 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 753.6 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 27.8 | flight-ready preview has only expected field-configuration gaps |
| pipeline flight-ready check-only with GIS override | PASS | 0 | 39.3 | command exited 0 |
...
2026-06-07 13:57:49,860 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 13:57:49,861 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
