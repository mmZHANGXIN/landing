...
- generated_at: `2026-06-07T17:19:26`
...
| GIS global-prior JSON acceptance self-test | PASS | 0 | 101.1 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 24.8 | command exited 0 |
| visualization source contract | PASS | 0 | 14.7 | command exited 0 |
| depth projection lightweight contract | PASS | 0 | 12.1 | command exited 0 |
...
| field runbook source contract | PASS | 0 | 15.6 | command exited 0 |
| field evidence status self-test | PASS | 0 | 444.7 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 84.8 | command exited 0 |
...
| experiment requirement audit self-test | PASS | 0 | 174.9 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 77.0 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 59.6 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 212.5 | command exited 0 |
| no-control runtime contract self-test | PASS | 0 | 15.1 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 172.4 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 81.2 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 100.9 | command exited 0 |
...
| flight-loop log acceptance self-test | PASS | 0 | 214.1 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 699.9 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 25.7 | flight-ready preview has only expected field-configuration gaps |
| pipeline flight-ready check-only with GIS override | PASS | 0 | 35.9 | command exited 0 |
...
2026-06-07 17:19:26,897 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 17:19:26,897 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
