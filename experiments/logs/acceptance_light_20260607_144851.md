...
- generated_at: `2026-06-07T14:48:51`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 28.8 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 22.7 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 16.4 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 61.4 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 25.5 | command exited 0 |
...
| field acceptance wrapper self-test | PASS | 0 | 37.2 | command exited 0 |
...
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 83.7 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 102.4 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 75.8 | command exited 0 |
...
| strict flight-ready gate regression | PASS | 0 | 710.1 | command exited 0 |
...
2026-06-07 14:48:51,495 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 14:48:51,495 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
