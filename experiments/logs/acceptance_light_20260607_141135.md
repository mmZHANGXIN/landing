...
- generated_at: `2026-06-07T14:11:35`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 28.3 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 22.2 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 16.4 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 65.7 | command exited 0 |
...
| no-control log acceptance self-test | PASS | 0 | 62.1 | command exited 0 |
...
| flight-loop log acceptance self-test | PASS | 0 | 61.9 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 722.3 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 26.4 | flight-ready preview has only expected field-configuration gaps |
...
2026-06-07 14:11:35,456 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 14:11:35,456 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
