...
- generated_at: `2026-06-07T13:38:57`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 32.8 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 23.6 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 17.7 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 28.2 | command exited 0 |
| visualization source contract | PASS | 0 | 16.0 | command exited 0 |
...
| no-control log acceptance self-test | PASS | 0 | 61.9 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 72.5 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 59.7 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 62.5 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 749.8 | command exited 0 |
...
2026-06-07 13:38:57,768 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 13:38:57,768 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
