...
- generated_at: `2026-06-07T15:50:57`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 31.8 | command exited 0 |
...
| HALSS visualization lightweight contract | PASS | 0 | 25.6 | command exited 0 |
...
| yaw-aware action decomposition | PASS | 0 | 16.0 | command exited 0 |
| runtime action-name labels | PASS | 0 | 21.5 | command exited 0 |
| field runbook source contract | PASS | 0 | 15.3 | command exited 0 |
| field evidence status self-test | PASS | 0 | 445.0 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 83.8 | command exited 0 |
...
| no-control log acceptance self-test | PASS | 0 | 148.9 | command exited 0 |
...
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 75.9 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 60.1 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 126.4 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 716.2 | command exited 0 |
...
2026-06-07 15:50:57,379 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 15:50:57,379 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
