...
- generated_at: `2026-06-07T16:19:09`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 32.2 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 23.0 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 16.6 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 63.9 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 26.6 | command exited 0 |
| visualization source contract | PASS | 0 | 15.8 | command exited 0 |
| depth projection lightweight contract | PASS | 0 | 12.3 | command exited 0 |
| SparseNet sparse convolution lightweight contract | PASS | 0 | 10.9 | command exited 0 |
| yaw-aware action decomposition | PASS | 0 | 15.3 | command exited 0 |
| runtime action-name labels | PASS | 0 | 21.5 | command exited 0 |
| field runbook source contract | PASS | 0 | 15.2 | command exited 0 |
| field evidence status self-test | PASS | 0 | 448.4 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 82.9 | command exited 0 |
| Orin environment report acceptance self-test | PASS | 0 | 94.3 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 15.3 | command exited 0 |
| experiment requirement audit self-test | PASS | 0 | 177.9 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 58.6 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 60.4 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 169.7 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 72.0 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 83.5 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 102.6 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 74.8 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 59.8 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 147.8 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 710.3 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 26.0 | flight-ready preview has only expected field-configuration gaps |
| pipeline flight-ready check-only with GIS override | PASS | 0 | 36.7 | command exited 0 |
...
2026-06-07 16:19:09,686 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 16:19:09,686 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
