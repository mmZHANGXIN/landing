...
- generated_at: `2026-06-07T14:01:14`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 35.2 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 23.8 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 17.7 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 62.4 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 27.9 | command exited 0 |
...
| yaw-aware action decomposition | PASS | 0 | 16.7 | command exited 0 |
| runtime action-name labels | PASS | 0 | 24.6 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 58.6 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 61.6 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 71.7 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 77.7 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 61.0 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 63.0 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 751.0 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 28.0 | flight-ready preview has only expected field-configuration gaps |
...
2026-06-07 14:01:14,301 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 14:01:14,301 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
