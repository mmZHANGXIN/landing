...
- generated_at: `2026-06-07T16:37:46`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 33.6 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 22.4 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 16.6 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 61.3 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 25.9 | command exited 0 |
| visualization source contract | PASS | 0 | 14.8 | command exited 0 |
...
| field runbook source contract | PASS | 0 | 15.5 | command exited 0 |
| field evidence status self-test | PASS | 0 | 440.0 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 80.8 | command exited 0 |
...
| timing log acceptance self-test | PASS | 0 | 58.2 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 189.9 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 94.4 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 81.0 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 99.3 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 74.4 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 59.0 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 165.6 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 697.0 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 25.3 | flight-ready preview has only expected field-configuration gaps |
| pipeline flight-ready check-only with GIS override | PASS | 0 | 36.5 | command exited 0 |
...
2026-06-07 16:37:46,128 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 16:37:46,128 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
