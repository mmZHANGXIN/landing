...
- generated_at: `2026-06-07T17:08:29`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 31.1 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 22.7 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 17.0 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 102.1 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 35.2 | command exited 0 |
| visualization source contract | PASS | 0 | 15.4 | command exited 0 |
| depth projection lightweight contract | PASS | 0 | 12.2 | command exited 0 |
...
| runtime action-name labels | PASS | 0 | 21.2 | command exited 0 |
| field runbook source contract | PASS | 0 | 15.2 | command exited 0 |
| field evidence status self-test | PASS | 0 | 435.4 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 85.6 | command exited 0 |
| Orin environment report acceptance self-test | PASS | 0 | 93.9 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 14.8 | command exited 0 |
| experiment requirement audit self-test | PASS | 0 | 171.7 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 57.1 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 61.6 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 213.5 | command exited 0 |
| no-control runtime contract self-test | PASS | 0 | 15.0 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 171.7 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 81.6 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 100.6 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 74.0 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 58.4 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 187.8 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 701.8 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 25.6 | flight-ready preview has only expected field-configuration gaps |
| pipeline flight-ready check-only with GIS override | PASS | 0 | 36.9 | command exited 0 |
...
2026-06-07 17:08:29,724 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 17:08:29,724 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
