...
- generated_at: `2026-06-07T15:34:20`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 31.0 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 22.7 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 17.5 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 62.2 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 25.4 | command exited 0 |
| visualization source contract | PASS | 0 | 15.6 | command exited 0 |
| depth projection lightweight contract | PASS | 0 | 11.9 | command exited 0 |
...
| field evidence status self-test | PASS | 0 | 152.9 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 83.6 | command exited 0 |
...
| field acceptance wrapper self-test | PASS | 0 | 59.9 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 58.9 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 148.5 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 72.1 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 82.9 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 103.2 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 75.5 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 60.0 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 125.4 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 715.4 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 25.8 | flight-ready preview has only expected field-configuration gaps |
| pipeline flight-ready check-only with GIS override | PASS | 0 | 37.3 | command exited 0 |
...
2026-06-07 15:34:20,663 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 15:34:20,663 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
