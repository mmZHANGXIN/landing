...
- generated_at: `2026-06-07T14:22:19`
...
| GIS global-prior JSON acceptance self-test | PASS | 0 | 77.0 | command exited 0 |
...
| no-control log acceptance self-test | PASS | 0 | 126.7 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 72.8 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 76.6 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 61.2 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 106.9 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 723.9 | command exited 0 |
...
2026-06-07 14:22:19,928 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 14:22:19,928 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
