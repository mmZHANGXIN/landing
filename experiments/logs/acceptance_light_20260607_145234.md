...
- generated_at: `2026-06-07T14:52:34`
...
| GIS global-prior JSON acceptance self-test | PASS | 0 | 65.0 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 26.0 | command exited 0 |
...
| yaw-aware action decomposition | PASS | 0 | 17.9 | command exited 0 |
| runtime action-name labels | PASS | 0 | 24.2 | command exited 0 |
| field runbook source contract | PASS | 0 | 15.0 | command exited 0 |
| field evidence status self-test | PASS | 0 | 71.4 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 15.3 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 37.6 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 58.5 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 149.4 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 73.1 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 84.5 | command exited 0 |
...
| flight-loop log acceptance self-test | PASS | 0 | 106.0 | command exited 0 |
...
2026-06-07 14:52:34,799 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 14:52:34,799 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
