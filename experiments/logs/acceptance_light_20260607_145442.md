...
- generated_at: `2026-06-07T14:54:42`
...
| SparseNet sparse convolution lightweight contract | PASS | 0 | 11.3 | command exited 0 |
...
| field evidence status self-test | PASS | 0 | 97.5 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 15.4 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 37.5 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 59.7 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 150.7 | command exited 0 |
...
| strict flight-ready gate regression | PASS | 0 | 709.4 | command exited 0 |
...
2026-06-07 14:54:42,508 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 14:54:42,508 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
