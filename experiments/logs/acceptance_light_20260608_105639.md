...
- generated_at: `2026-06-08T10:56:39`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 32.5 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 22.9 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 18.1 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 104.9 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 25.7 | command exited 0 |
| visualization source contract | PASS | 0 | 15.3 | command exited 0 |
| depth projection lightweight contract | PASS | 0 | 14.1 | command exited 0 |
| SparseNet sparse convolution lightweight contract | PASS | 0 | 11.2 | command exited 0 |
| yaw-aware action decomposition | PASS | 0 | 15.2 | command exited 0 |
| runtime action-name labels | PASS | 0 | 22.0 | command exited 0 |
| field runbook source contract | FAIL | 1 | 15.4 | command exited 1 |
| field evidence status self-test | PASS | 0 | 781.6 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 89.4 | command exited 0 |
| Orin environment report acceptance self-test | PASS | 0 | 96.4 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 15.6 | command exited 0 |
| experiment requirement audit self-test | PASS | 0 | 179.7 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 78.7 | command exited 0 |
| closed-loop diagnostic snapshot contract | PASS | 0 | 16.8 | command exited 0 |
| MAVSDK home telemetry contract | PASS | 0 | 14.9 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 58.4 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 219.1 | command exited 0 |
| no-control action diagnosis self-test | PASS | 0 | 103.8 | command exited 0 |
| no-control runtime contract self-test | PASS | 0 | 15.3 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 174.2 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 82.8 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 102.4 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 75.0 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 59.5 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 264.9 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 757.4 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 25.8 | flight-ready preview has only expected field-configuration gaps |
| pipeline flight-ready check-only with GIS override | PASS | 0 | 37.4 | command exited 0 |
...
Traceback (most recent call last):
  File "/Users/evelyn/Desktop/orinlanding/orinlanding/test_runbook_contract_light.py", line 311, in <module>
    main()
  File "/Users/evelyn/Desktop/orinlanding/orinlanding/test_runbook_contract_light.py", line 297, in main
    test_readme_realtime_claims_are_measured_not_assumed()
  File "/Users/evelyn/Desktop/orinlanding/orinlanding/test_runbook_contract_light.py", line 142, in test_readme_realtime_claims_are_measured_not_assumed
    _require_all(
  File "/Users/evelyn/Desktop/orinlanding/orinlanding/test_runbook_contract_light.py", line 16, in _require_all
    assert not missing, f"{label} missing: {missing}"
AssertionError: README measured realtime claims missing: ['NumPy 透视投影 + z-buffer']
```
...
2026-06-08 10:56:39,995 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-08 10:56:39,996 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
