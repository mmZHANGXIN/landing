...
- generated_at: `2026-06-07T16:05:25`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 31.7 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 22.8 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 17.9 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 64.5 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 25.2 | command exited 0 |
| visualization source contract | PASS | 0 | 15.0 | command exited 0 |
...
| Orin environment check self-test | PASS | 0 | 85.8 | command exited 0 |
| Orin environment report acceptance self-test | PASS | 0 | 95.4 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 15.3 | command exited 0 |
| experiment requirement audit self-test | PASS | 0 | 174.0 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 58.6 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 62.3 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 171.1 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 71.8 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 83.6 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 102.7 | command exited 0 |
...
| flight-loop log acceptance self-test | PASS | 0 | 149.7 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 718.7 | command exited 0 |
...
2026-06-07 16:05:25,047 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 16:05:25,048 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
