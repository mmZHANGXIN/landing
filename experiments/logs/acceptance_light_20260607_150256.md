...
- generated_at: `2026-06-07T15:02:56`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 32.0 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 23.1 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 17.3 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 63.3 | command exited 0 |
...
| field evidence status self-test | PASS | 0 | 97.7 | command exited 0 |
...
| timing log acceptance self-test | PASS | 0 | 64.6 | command exited 0 |
...
| ROS topic evidence acceptance self-test | PASS | 0 | 59.6 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 104.2 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 710.0 | command exited 0 |
...
2026-06-07 15:02:56,134 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 15:02:56,134 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
