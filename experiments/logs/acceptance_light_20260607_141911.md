...
- generated_at: `2026-06-07T14:19:11`
...
| HALSS visualization lightweight contract | PASS | 0 | 27.4 | command exited 0 |
...
| no-control log acceptance self-test | PASS | 0 | 125.3 | command exited 0 |
...
| strict flight-ready gate regression | PASS | 0 | 722.2 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 26.5 | flight-ready preview has only expected field-configuration gaps |
...
2026-06-07 14:19:11,127 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 14:19:11,127 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
