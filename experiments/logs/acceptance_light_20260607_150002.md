...
- generated_at: `2026-06-07T15:00:02`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 33.3 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 22.8 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 16.8 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 63.4 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 26.2 | command exited 0 |
...
| field runbook source contract | PASS | 0 | 15.7 | command exited 0 |
| field evidence status self-test | PASS | 0 | 99.2 | command exited 0 |
...
| field acceptance wrapper self-test | PASS | 0 | 37.3 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 58.5 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 148.0 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 72.5 | command exited 0 |
...
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 79.2 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 61.6 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 104.6 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 718.5 | command exited 0 |
...
2026-06-07 15:00:02,194 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 15:00:02,194 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
