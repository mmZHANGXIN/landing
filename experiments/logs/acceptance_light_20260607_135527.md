...
- generated_at: `2026-06-07T13:55:27`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 32.7 | command exited 0 |
...
| HALSS visualization lightweight contract | PASS | 0 | 27.8 | command exited 0 |
...
| runtime action-name labels | PASS | 0 | 24.9 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 59.7 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 64.5 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 72.7 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 77.8 | command exited 0 |
...
| strict flight-ready gate regression | PASS | 0 | 748.4 | command exited 0 |
...
2026-06-07 13:55:27,261 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 13:55:27,262 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
