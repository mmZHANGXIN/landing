...
- generated_at: `2026-06-07T15:20:29`
...
| HALSS visualization lightweight contract | PASS | 0 | 25.8 | command exited 0 |
...
| yaw-aware action decomposition | PASS | 0 | 15.7 | command exited 0 |
| runtime action-name labels | PASS | 0 | 21.3 | command exited 0 |
| field runbook source contract | PASS | 0 | 15.8 | command exited 0 |
| field evidence status self-test | PASS | 0 | 152.4 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 80.6 | command exited 0 |
| Orin environment report acceptance self-test | PASS | 0 | 95.2 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 15.0 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 58.4 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 58.6 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 148.0 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 72.2 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 84.3 | command exited 0 |
...
| flight-loop log acceptance self-test | PASS | 0 | 104.2 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 712.9 | command exited 0 |
...
2026-06-07 15:20:29,608 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 15:20:29,608 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
