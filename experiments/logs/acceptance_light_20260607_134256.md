...
- generated_at: `2026-06-07T13:42:56`
...
| HALSS visualization lightweight contract | PASS | 0 | 26.3 | command exited 0 |
...
| runtime action-name labels | PASS | 0 | 24.3 | command exited 0 |
...
| strict flight-ready gate regression | PASS | 0 | 746.9 | command exited 0 |
...
2026-06-07 13:42:56,958 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 13:42:56,959 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
