...
- generated_at: `2026-06-07T16:46:11`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 29.6 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 23.5 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 18.0 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 62.7 | command exited 0 |
...
| field evidence status self-test | PASS | 0 | 439.9 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 81.6 | command exited 0 |
| Orin environment report acceptance self-test | PASS | 0 | 92.6 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 14.9 | command exited 0 |
| experiment requirement audit self-test | PASS | 0 | 173.2 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 56.2 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 58.9 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 212.9 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 94.2 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 81.3 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 100.3 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 74.0 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 58.5 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 187.7 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 698.0 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 25.4 | flight-ready preview has only expected field-configuration gaps |
...
2026-06-07 16:46:11,918 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 16:46:11,919 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
