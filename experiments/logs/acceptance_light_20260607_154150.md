...
- generated_at: `2026-06-07T15:41:50`
...
| GIS global-prior JSON acceptance self-test | PASS | 0 | 61.6 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 25.1 | command exited 0 |
...
| field runbook source contract | PASS | 0 | 14.5 | command exited 0 |
| field evidence status self-test | PASS | 0 | 441.9 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 85.5 | command exited 0 |
| Orin environment report acceptance self-test | PASS | 0 | 96.0 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 15.3 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 58.0 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 59.7 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 149.3 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 72.8 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 82.9 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 102.6 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 75.3 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 60.3 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 126.6 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 713.9 | command exited 0 |
...
2026-06-07 15:41:50,562 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 15:41:50,562 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
