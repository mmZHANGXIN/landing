...
- generated_at: `2026-06-08T11:36:18`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 30.5 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 23.0 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 18.6 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 104.1 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 24.8 | command exited 0 |
| visualization source contract | PASS | 0 | 14.6 | command exited 0 |
| depth projection lightweight contract | PASS | 0 | 13.5 | command exited 0 |
| CUDA depth projection log acceptance self-test | PASS | 0 | 74.1 | command exited 0 |
| SparseNet sparse convolution lightweight contract | PASS | 0 | 11.1 | command exited 0 |
| yaw-aware action decomposition | PASS | 0 | 14.7 | command exited 0 |
| runtime action-name labels | PASS | 0 | 21.0 | command exited 0 |
| field runbook source contract | PASS | 0 | 14.8 | command exited 0 |
| field evidence status self-test | PASS | 0 | 783.4 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 85.0 | command exited 0 |
| Orin environment report acceptance self-test | PASS | 0 | 93.0 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 14.5 | command exited 0 |
| experiment requirement audit self-test | PASS | 0 | 173.4 | command exited 0 |
| field acceptance wrapper self-test | PASS | 0 | 75.6 | command exited 0 |
| closed-loop diagnostic snapshot contract | PASS | 0 | 18.0 | command exited 0 |
| MAVSDK home telemetry contract | PASS | 0 | 14.3 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 56.9 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 210.2 | command exited 0 |
| no-control action diagnosis self-test | PASS | 0 | 99.9 | command exited 0 |
| no-control runtime contract self-test | PASS | 0 | 15.0 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 169.2 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 80.9 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 99.3 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 73.0 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 58.1 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 259.0 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 736.2 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 24.9 | flight-ready preview has only expected field-configuration gaps |
| pipeline flight-ready check-only with GIS override | PASS | 0 | 35.5 | command exited 0 |
...
```text
$ /Library/Developer/CommandLineTools/usr/bin/python3 /Users/evelyn/Desktop/orinlanding/orinlanding/test_accept_depth_projection_cuda_light.py
=== Lightweight CUDA depth projection acceptance ===
  OK good CUDA parity log passes
  OK missing parity case fails
  OK CUDA-unavailable log fails
=== ALL PASSED ===
```
...
2026-06-08 11:36:18,267 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-08 11:36:18,267 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
