...
- generated_at: `2026-06-07T14:33:36`
...
| GIS global-prior JSON acceptance self-test | PASS | 0 | 62.9 | command exited 0 |
...
| field evidence status self-test | PASS | 0 | 69.6 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 61.1 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 128.3 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 73.3 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 83.9 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 103.4 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 76.3 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 60.8 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 105.9 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 755.9 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 27.6 | flight-ready preview has only expected field-configuration gaps |
| pipeline flight-ready check-only with GIS override | PASS | 0 | 40.2 | command exited 0 |
...
2026-06-07 14:33:36,540 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 14:33:36,541 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
