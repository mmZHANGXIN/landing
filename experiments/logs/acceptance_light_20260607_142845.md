...
- generated_at: `2026-06-07T14:28:45`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 31.5 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 23.1 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 17.4 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 69.0 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 28.9 | command exited 0 |
| visualization source contract | PASS | 0 | 16.2 | command exited 0 |
| depth projection lightweight contract | PASS | 0 | 13.4 | command exited 0 |
| SparseNet sparse convolution lightweight contract | PASS | 0 | 11.6 | command exited 0 |
| yaw-aware action decomposition | PASS | 0 | 16.2 | command exited 0 |
| runtime action-name labels | PASS | 0 | 23.0 | command exited 0 |
| field runbook source contract | PASS | 0 | 16.8 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 68.5 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 137.6 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 86.5 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 88.4 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 108.2 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 88.7 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 64.0 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 108.9 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 759.1 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 27.0 | flight-ready preview has only expected field-configuration gaps |
| pipeline flight-ready check-only with GIS override | PASS | 0 | 38.9 | command exited 0 |
...
2026-06-07 14:28:45,555 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 14:28:45,555 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
