...
- generated_at: `2026-06-07T14:36:53`
...
| DRL SB3 metadata | PASS | 0 | 23.2 | command exited 0 |
| GIS nine-grid lightweight contract | PASS | 0 | 17.2 | command exited 0 |
| GIS global-prior JSON acceptance self-test | PASS | 0 | 64.1 | command exited 0 |
| HALSS visualization lightweight contract | PASS | 0 | 26.9 | command exited 0 |
...
| yaw-aware action decomposition | PASS | 0 | 15.6 | command exited 0 |
| runtime action-name labels | PASS | 0 | 21.8 | command exited 0 |
| field runbook source contract | PASS | 0 | 15.1 | command exited 0 |
| field evidence status self-test | PASS | 0 | 70.6 | command exited 0 |
| requirement traceability source contract | PASS | 0 | 15.1 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 59.8 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 128.4 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 73.6 | command exited 0 |
| DRL diagnosis JSON acceptance self-test | PASS | 0 | 86.0 | command exited 0 |
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 104.3 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 76.9 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 61.5 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 107.0 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 769.6 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 27.1 | flight-ready preview has only expected field-configuration gaps |
| pipeline flight-ready check-only with GIS override | PASS | 0 | 38.3 | command exited 0 |
...
2026-06-07 14:36:53,121 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 14:36:53,121 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
