...
- generated_at: `2026-06-07T15:07:41`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 29.9 | command exited 0 |
| DRL SB3 metadata | PASS | 0 | 22.6 | command exited 0 |
...
| field runbook source contract | PASS | 0 | 14.6 | command exited 0 |
| field evidence status self-test | PASS | 0 | 126.4 | command exited 0 |
| Orin environment check self-test | PASS | 0 | 83.5 | command exited 0 |
| Orin environment report acceptance self-test | PASS | 0 | 76.4 | command exited 0 |
...
| timing log acceptance self-test | PASS | 0 | 59.1 | command exited 0 |
...
| SparseNet calibration JSON acceptance self-test | PASS | 0 | 102.2 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 74.8 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 60.4 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 105.1 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 714.1 | command exited 0 |
...
2026-06-07 15:07:41,385 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 15:07:41,385 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
