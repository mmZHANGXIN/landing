...
- generated_at: `2026-06-07T13:52:52`
...
| --- | --- | ---: | ---: | --- |
| preflight config/assets without model load | PASS | 0 | 35.8 | command exited 0 |
...
| SparseNet sparse convolution lightweight contract | PASS | 0 | 11.7 | command exited 0 |
| yaw-aware action decomposition | PASS | 0 | 16.0 | command exited 0 |
| runtime action-name labels | PASS | 0 | 24.6 | command exited 0 |
| timing log acceptance self-test | PASS | 0 | 59.8 | command exited 0 |
| no-control log acceptance self-test | PASS | 0 | 62.6 | command exited 0 |
| no-control artifact acceptance self-test | PASS | 0 | 73.3 | command exited 0 |
| saved binary semantic NPZ/PNG comparison self-test | PASS | 0 | 79.3 | command exited 0 |
| ROS topic evidence acceptance self-test | PASS | 0 | 60.7 | command exited 0 |
| flight-loop log acceptance self-test | PASS | 0 | 62.2 | command exited 0 |
| strict flight-ready gate regression | PASS | 0 | 747.6 | command exited 0 |
| flight-ready preflight preview | PASS | 1 | 27.6 | flight-ready preview has only expected field-configuration gaps |
| pipeline flight-ready check-only with GIS override | PASS | 0 | 39.0 | command exited 0 |
...
2026-06-07 13:52:52,517 [INFO] OrinLanding: [FlightReady] Preview gates passed before model initialization
2026-06-07 13:52:52,517 [INFO] OrinLanding: [FlightReady] Check-only mode complete.
```
